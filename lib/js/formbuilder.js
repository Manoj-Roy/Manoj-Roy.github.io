...
(function() {
  Formbuilder.registerField('button', {
    order: 0,
    view: "<input type='button' class='waves-effect waves-light btn' value='<%= rf.get(Formbuilder.options.mappings.VALUE) %>'/>",
    edit: "<%= Formbuilder.templates['edit/value']() %>\n",
    addButton: "<span class='symbol'><i class='fa fa-angle-double-right' aria-hidden='true'></i></span> Button",
    defaultAttributes: function(attrs) {
      attrs.field_options.value = 'submit';
      return attrs;
    }
  });
...
((__t = ( Formbuilder.options.mappings.LABEL )) == null ? '' : __t) +
'\' />\n<textarea class="materialize-textarea" data-rv-input=\'model.' +
...
'" style="width: 30px" />\n\n&nbsp;&nbsp;\n\n<select class="numChar" data-rv-value="model.' +
...
// for button value custom add
this["Formbuilder"]["templates"]["edit/value"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-edit-section-header\'>Button Name</div>\n<input type="text" class="btnValue" data-rv-value="model.' +
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-right\'>\n  <form action="#"><div class=\'fb-no-response-fields\'>No response fields</div>\n  <div class=\'fb-response-fields\'></div>\n</div>\n';
...
// duplicate and just enabled minus buton
__p += '<div class=\'actions-wrapper\'>\n  <a class="js-clear ' +
((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
'" title="Remove Field"><i class=\'fa fa-minus-circle\'></i></a>\n</div>';
